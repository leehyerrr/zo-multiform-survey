...
function SendModalContent({ surveyId, emailCollected, onClose }: Props) {
  ...
  const handleChangeEmailColleced = (value: boolean) => {
    callApi(`/surveys/${surveyId}`, { method: 'PATCH', body: { emailCollected: value } })
  }

  return (
    <Panel className="text-gray900">
      <PanelHeader className="flex justify-between items-center py-15 pt-0 -mt-10">
      ...
      <PanelBody>
        <div className="-mx-20 px-20 bg-bg flex justify-between items-center py-13 mb-38">
          ...
          <Dropdown<boolean>
            ...
            onChange={handleChangeEmailColleced}
          />
        </div>
